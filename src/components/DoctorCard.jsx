    ...
    <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-4 w-full md:w-auto">
        ...
        <div>
          ...
          <p className="text-[#468EEC] text-sm font-medium">{doctor.specialty}</p>
          ...
          <div className="flex items-center gap-8 text-xs mt-1 text-black">
            <div><i className="fa-solid fa-location-dot  text-[#4a90e2] "></i> {doctor.location}</div> 
              <div className="font-bold">  <i className="fa-solid fa-wallet text-[#4a90e2]"></i> {doctor.price} جنيه</div>
      ...
      <div className="flex flex-col items-center md:items-end w-full md:w-auto gap-3">
        <span className={`px-3 py-1 rounded-full text-xs font-bold ${
          doctor.available ? "bg-green-100 text-green-600" : "bg-orange-100 text-orange-600"
        }`}>
